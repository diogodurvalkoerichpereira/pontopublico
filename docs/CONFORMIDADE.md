...
| RPPS | 🟢 | Tabela do ente (O1-02a), regime como dado de primeira classe (O1-02b), rubricas aplicadas automaticamente por regime no ciclo com checksum na memória (O1-02c), tela de regimes + mapeamento de rubricas e seletor de regime na ficha da pessoa (O1-02d). Falta só a tela do write-path de tabelas fiscais (back-end pronto em O1-02a) |
